        ...
        <div class="row">
          <div class="col-lg-8">
            <div class="cs-post cs-style2">
              <a href="blog-details.php" class="cs-post_thumb cs-radius_15">
              ...
              <div class="cs-post_info">
                ...
                <a href="blog-details.php" class="cs-text_btn">
                  <span>See More</span>
            ...
            <ul class="cs-pagination_box cs-center cs-white_color cs-mp0 cs-semi_bold">
              <li>
                <a class="cs-pagination_item cs-center active" href="blog.php">1</a>
              </li>
              <li>
                <a class="cs-pagination_item cs-center" href="blog.php">2</a>
              </li>
              <li>
                <a class="cs-pagination_item cs-center" href="blog.php">3</a>
              </li>
              <li>
                <a class="cs-pagination_item cs-center" href="blog.php">4</a>
              </li>
              <li>
