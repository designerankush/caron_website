<?php include 'includes/header.php'; ?>
      ...
      <div class="cs-side_header_box">
        ...
        <ul class="cs-contact_info cs-style1 cs-mp0">
          ...
          <li>
            ...
            <span>Phase 8B, Industrial Area, C-253 <br>Mohali, India </span>
          </li>
        </ul>
      </div>
      ...
      <div class="row align-items-center">
        <div class="col-12">
          <div class="cs-section_heading cs-style1 text-center">
            ...
            <h2 class="cs-section_title">Your trusted partner for business </h2>
            <p>With Caron Infotech, we step into a new era where advanced AI, cutting-edge software, and sophisticated
              automation<br> technologies converge to redefine what's possible in development, following modern AI tools
              and latest trends, we offer these advantages:
            </p>
          </div>
        </div>

        <div class="col-md-4">
          <div class="services_block text-center mt-4 mt-xl-5">
            <em class="d-block text-center mb-3">
              <img src="assets/img/icons/cost_icon.svg" alt="Cost Efficiency" class="d-inline-block" width="70" />
            </em>
            <h6 class="mb-2">Cost Efficiency Redefined</h6>
            <p>Avoid the financial pitfalls of hiring overpriced or underqualified developers. Caron Infotech zeroes in
              on development tasks with the highest return on investment, allowing you to allocate your resources where
              they matter most – your core business operations.</p>
          </div>
        </div>
        ...
        <div class="col-md-4">
          <div class="services_block text-center mt-4 mt-xl-5">
            <em class="d-block mb-3">
              <img src="assets/img/icons/velocity_icon.svg" alt="Cost Efficiency" class="d-inline-block" width="70" />
            </em>
            <h6 class="mb-2">Accelerated Development Velocity</h6>
            <p>Say goodbye to project delays and endless meetings. Our streamlined development cycles ensure your
              projects move forward at an unprecedented pace, potentially quadrupling your development speed and
              bringing your vision to life faster than ever before. </p>
          </div>
        </div>
        ...
        <div class="col-md-4">
          <div class="services_block text-center mt-4 mt-xl-5">
            <em class="d-block mb-3">
              <img src="assets/img/icons/quality_icon.svg" alt="Quality Assurance" class="d-inline-block" width="70" />
            </em>
            <h6 class="mb-2">Uncompromised Quality Assurance</h6>
            <p>With Caron Infotech, quality is never an afterthought. Our meticulous project management approach reduces
              miscommunications and inconsistencies, ensuring that every development project meets the highest standards
              of quality.</p>
          </div>
        </div>
      ...
      <div class="row align-items-center">
        ...
        <div class="col-lg-7">
          <div class="cs-section_heading cs-style1">
            ...
            <h2 class="h3">Highly experienced pepole with us</h2>
            <p class="cs-m0">Caron Infotech is not just a service provider; we are your innovation partner, committed to
              transforming the landscape of software development with our unique blend of expertise, efficiency, and
              excellence.</p>
            <div class="cs-height_15 cs-height_lg_15"></div>
            <p class="cs-m0">In the ever-evolving digital landscape, your online presence is more than just a
              necessity—it's your brand's voice, your business's storefront, and your game's gateway to the world. At
              Caron Infotech, we specialize in turning your digital dreams into reality through our bespoke web, mobile,
              and game development services. We aim to craft immersive experiences that captivate, engage, and deliver
              results.</p>
          </div>
        </div>
      </div>
        ...
        <div class="row">
          <div class="col-12 mb-3 mb-lg-4">
            <div class="single-process magnetic-item">
              ...
              <p>Our Mission is to help entrepreneurs build useful and enduring technology products to keep pushing
                innovation forward. I am a go-to choice for various startups looking to launch attractive and scalable
                applications.

                We Work together at Caron Infotech to empower the digital visions of our Partner clients through agile
                methodology and a test-driven approach. That helps to keep transparency during the project for the
                stakeholders is our core priority.</p>
            </div>
          </div>
          <div class="col-lg-4 col-sm-6 mb-3">
            <div class="single-process magnetic-item">
              <h3 class="h4">Our Team</h3>
              <p>We have insightful creative minds and technical experts that fuel Caron Infotech's success in
                delivering exceptional digital solutions, and work in a fast-paced environment.
                We are Expert in finding custom solutions for your business THAT WORKS!!</p>
            </div>
          </div>
          <div class="col-lg-4 col-sm-6 mb-3">
            <div class="single-process magnetic-item">
              <h3 class="h4">Our Values</h3>
              <p>The core values that guide Caron Infotech—are innovation, quality, client focus, and integrity.</p>
            </div>
          </div>
          <div class="col-lg-4 col-sm-6 mb-3">
            <div class="single-process magnetic-item">
              <h3 class="h4">Join Our Journey</h3>
              <p>An invitation for potential clients and talents to become part of Caron Infotech's story, either by
                partnering with us for their digital development needs or by exploring career opportunities.</p>
            </div>
          </div>
        </div>
      </div>
  ...
  <section>
    <div class="container">
      <div class="cs-slider cs-style2 cs-gap-24 text-center">
        <div class="cs-slider_heading cs-style1 justify-content-center">
          <div class="cs-section_heading cs-style1">
            <h3 class="cs-section_subtitle">Behind the Screens</h3>
            <h2 class="cs-section_title">The Caron Infotech Story</h2>
          </div>
        </div>
        ...
        <div class="cs-slider_container" data-autoplay="0" data-loop="1" data-speed="600" data-center="0"
          ...
          <div class="cs-slider_wrapper">
            <div class="cs-slide">
              <div class="cs-team cs-style1">
                <div class="cs-member_thumb">
                  <img src="assets/img/team/manish.jpg" alt="Manish Srivastav">
                  <div class="cs-member_overlay"></div>
                </div>
                <div class="cs-member_info">
                  <h2 class="cs-member_name">Manish Srivastav</h2>
                  <span class="cs-member_designation">CEO </span>
                </div>
                <div class="cs-member_social cs-primary_color">
                  <a href="https://www.linkedin.com/in/manish-srivastav-698855120/" target="_blank">
			...
			<div class="cs-slide">
                <div class="cs-team cs-style1">
                  <div class="cs-member_thumb">
                    <img src="assets/img/team/ankush.webp" alt="Ankush" title="Ankush Kumar">
                    <div class="cs-member_overlay"></div>
                  </div>
                  <div class="cs-member_info">
                    <h2 class="cs-member_name">Ankush Kumar</h2>
                    <span class="cs-member_designation">COO</span>
                  </div>
                  <div class="cs-member_social cs-primary_color">
                    <a href="https://www.linkedin.com/in/ankushkamrana/" target="_blank">
                      <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="cs-slide">
              <div class="cs-team cs-style1">
                <div class="cs-member_thumb">
                  <img src="assets/img/team/mukhpal.jpg" alt="Mukhpal Singh">
                  <div class="cs-member_overlay"></div>
                </div>
                <div class="cs-member_info">
                  <h2 class="cs-member_name">Mukhpal Singh</h2>
                  <span class="cs-member_designation">CTO</span>
                </div>
                <div class="cs-member_social cs-primary_color">
                  <a href="https://www.linkedin.com/in/mukhpal-singh/" target="_blank">
                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path
                        d="M5.39756 18.333H1.9422V7.20581H5.39756V18.333ZM3.66802 5.68795C2.56311 5.68795 1.6669 4.77277 1.6669 3.66786C1.6669 3.13714 1.87773 2.62814 2.25301 2.25286C2.6283 1.87758 3.13729 1.66675 3.66802 1.66675C4.19875 1.66675 4.70774 1.87758 5.08302 2.25286C5.4583 2.62814 5.66913 3.13714 5.66913 3.66786C5.66913 4.77277 4.77256 5.68795 3.66802 5.68795ZM18.3298 18.333H14.8819V12.9164C14.8819 11.6255 14.8559 9.96995 13.0854 9.96995C11.2889 9.96995 11.0136 11.3725 11.0136 12.8234V18.333H7.56199V7.20581H10.876V8.72367H10.9243C11.3857 7.84941 12.5125 6.92679 14.1937 6.92679C17.6907 6.92679 18.3336 9.22962 18.3336 12.2207V18.333H18.3298Z"
                        fill="currentColor" />
