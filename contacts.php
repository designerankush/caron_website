<?php include 'includes/header.php'; ?>
  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-6">
        ...
        <ul class="cs-contact_info cs-style1 cs-mp0">
          ...
          <li>
            ...
            <a class="text-white" href="mailto:manish@caroninfotech.com">manish@caroninfotech.com</span>,<br/>
            <a class="text-white" href="mailto:mukhpal.singh@caroninfotech.com">mukhpal.singh@caroninfotech.com</a><br/>
            <!-- <span>ankush.kumar@caroninfotech.com</span> -->
          </li>
          <li>
            ...
            <span>C-253, Phase 8B, Industrial Area, <br/>
              SAS Nagar (Punjab), India <br/>
              160071
            </span>
          </li>
        </ul>
      ...
      <div class="col-lg-6">
        <form id="cs-form" action="contact.php" method="POST" class="row">
          <div class="col-sm-6">
          ...
          <div class="col-sm-6">
            ...
            <input type="text" class="cs-form_field" name="number">
            <div class="cs-height_20 cs-height_lg_20"></div>
          </div>
          <div class="col-lg-12">
