<?php include 'includes/header.php'; ?>
  ...
  <div class="container">
    <div class="cs-portfolio_details">
      <img src="assets/img/portfolios/eyeglass_detail.jpg" alt="caron Infotech" class="cs-radius_15 w-100">
      <div class="cs-height_50 cs-height_lg_40"></div>
      <div class="row">
        <div class="col-lg-6">
          <div class="cs-section_heading cs-style1">
            <h3 class="cs-section_subtitle">Creative</h3>
            <h2 class="cs-section_title">EyeGlasses</h2>
            <div class="cs-height_40 cs-height_lg_20"></div>
            <p>This website typically serves as an online retailer specializing in eyeglasses, sunglasses, and possibly related accessories. Most such websites offer a wide range of products from various brands, featuring different styles and types of lenses.</p>
            <div class="cs-height_10 cs-height_lg_10"></div>
            <p>Customers can usually browse frames by type, brand, shape, material, and price. Additionally, websites like eyeglasses.com often provide services like virtual try-ons, where you can upload a photo of yourself to see how different frames might look on your face. They might also allow you to input your eyeglass prescription directly on the site to order customized lenses.</p>
          </div>
        </div>
