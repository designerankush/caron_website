<?php include 'includes/header.php'; ?>
      ...
      <div class="row">
        <div class="col-12">
          <div class="cs-section_heading cs-style1">
            <h3 class="cs-section_subtitle">Tailored Product Development Services</h3>
  ...
  <section>
    <div class="container" bis_skin_checked="1">
      <div class="row align-items-center" bis_skin_checked="1">
        <div class="col-lg-4 order-lg-2" bis_skin_checked="1">
          <div class="cs-image_layer cs-style1" bis_skin_checked="1">
            <div class="cs-image_layer_in" bis_skin_checked="1">
              <img src="assets/img/skilled.jpg" alt="Image" class="w-100 cs-radius_15">
            </div>
          </div>
          <div class="cs-height_0 cs-height_lg_40" bis_skin_checked="1"></div>
        </div>
        <div class="col-lg-8 order-lg-1" bis_skin_checked="1">
          <div class="cs-section_heading cs-style1" bis_skin_checked="1">
            <h3 class="cs-section_subtitle">Caron Infotech</h3>
            <h2 class="h3">Your Partner in Digital Innovation</h2>
            <p>Welcome to Caron Infotech, where we blend speed, innovation, and customization to transform your digital dreams into reality. Our suite of services is designed to cater to every aspect of your software development journey, ensuring that your project not only takes off but soars.</p> 
          </div>
        </div>
      </div>
    </div>
  ...
  <section class="cs-shape_wrap_4 cs-parallax">
    <div class="container">
      <div class="row">
        <div class="col-12">
          <div class="cs-section_heading cs-style1">
            <h2 class="cs-section_title">Core Services</h2>
          </div>
      ...
      <div class="row">
        <div class="col-md-4 mb-4">
          <div class="services_block">
            <!-- <em><img src="assets/img/icons/services/Web-Development.svg" alt="Web Development" width="40" /></em> -->
            <h4 class="h5 mb-2">SAAS Development</h4>
            <p>Experience unprecedented speed in bringing your software application's Minimum Viable Product (MVP) to
              life. At Caron Infotech, we understand that time is of the essence. Let us help you accelerate your
        ...
        <div class="col-md-4 mb-4">
          <div class="services_block">
            <!-- <em><img src="assets/img/icons/services/Game-Development.svg" alt="" width="40" /></em> -->
            <h4 class="h5 mb-2">Artificial Intelligence</h4>
            <p>Dive into the future with our AI development services. From simple solutions to complex systems powered
              by Large Language Models, we're here to make AI accessible, powerful, and relevant to your business needs.
            </p>
          </div>
        </div>
        ...
        <div class="col-md-4 mb-4">
          <div class="services_block">
            <!-- <em><img src="assets/img/icons/services/Mobile-Development.svg" alt="" width="40" /></em> -->
            <h4 class="h5 mb-2">Business Management Solutions</h4>
            <p>Imagine a business management application that's as unique as your business. We specialize in creating
              custom solutions that fit like a glove, enhancing your internal operations and boosting productivity.</p>
          </div>
        </div>
        ...
        <div class="col-md-4 mb-4">
          <div class="services_block">
            <!-- <em><img src="assets/img/icons/services/Mobile-Development.svg" alt="" width="40" /></em> -->
            <h4 class="h5 mb-2">Custom CRM Systems</h4>
            <p>Say goodbye to one-size-fits-all CRM systems. Our bespoke CRM solutions are crafted with your clients in
              mind, ensuring seamless integration, enhanced relationships, and no dependency on third-party apps.</p>
          </div>
        </div>
        <div class="col-md-4 mb-4">
          <div class="services_block">
            <!-- <em><img src="assets/img/icons/services/Mobile-Development.svg" alt="" width="40" /></em> -->
            <h4 class="h5 mb-2">Custom AI Chatbots</h4>
            <p>Elevate your customer service with AI chatbots tailored to your knowledge base. These versatile systems
              provide timely, accurate responses across various use cases, ensuring customer satisfaction round the
              clock.</p>
          </div>
        </div>
  ...
  <!-- Start Design and User Experience -->
  <section class="cs-shape_wrap_4 cs-parallax">
    <div class="container">
      <div class="row">
        <div class="col-12">
          <div class="cs-section_heading cs-style1">
            <h2 class="cs-section_title">Design and User Experience</h2>
          </div>
          <div class="cs-height_30 cs-height_lg_45"></div>
        </div>
      </div>
      ...
      <div class="row">
        <div class="col-md-4 mb-4">
          <div class="services_block">
            <!-- <em><img src="assets/img/icons/services/Web-Development.svg" alt="Web Development" width="40" /></em> -->
            <h4 class="h5 mb-2">App Design (UI/UX)</h4>
            <p>First impressions matter. Our UI/UX designs are more than just aesthetically pleasing; they're intuitive,
              user-friendly, and aligned with your brand identity. Let's create experiences that captivate and retain
              your users.</p>
          </div>
        </div>
        ...
        <div class="col-md-4 mb-4">
          <div class="services_block">
            <!-- <em><img src="assets/img/icons/services/Game-Development.svg" alt="" width="40" /></em> -->
            <h4 class="h5 mb-2">Custom Websites</h4>
            <p>Your website is the digital face of your brand. We specialize in creating custom websites that stand out
              for their unique design and compelling user experience, making every visit memorable.</p>
          </div>
        </div>
      </div>
    </div>
  ...
  <!-- Start Automation and Extensions-->
  <section class="cs-shape_wrap_4 cs-parallax">
    <div class="container">
      <div class="row">
        <div class="col-12">
          <div class="cs-section_heading cs-style1">
            <h2 class="cs-section_title">Automation and Extensions</h2>
          </div>
          <div class="cs-height_30 cs-height_lg_45"></div>
        </div>
      </div>
      ...
      <div class="row">
        <div class="col-md-4 mb-4">
          <div class="services_block">
            <!-- <em><img src="assets/img/icons/services/Web-Development.svg" alt="Web Development" width="40" /></em> -->
            <h4 class="h5 mb-2">Workflow Automation</h4>
            <p>Streamline your operations with our workflow automation services. By eliminating repetitive tasks, we free up your team to focus on what they do best, driving efficiency and innovation.</p>
          </div>
        </div>
        ...
        <div class="col-md-4 mb-4">
          <div class="services_block">
            <!-- <em><img src="assets/img/icons/services/Game-Development.svg" alt="" width="40" /></em> -->
            <h4 class="h5 mb-2">Chrome Extensions</h4>
            <p>Enhance your browser's functionality with our custom Chrome extensions. Whether it's connecting to your app or functioning standalone, our extensions are designed to improve productivity and user experience.
            </p>
          </div>
        </div>
      </div>
  ...
  <!-- Start Integration and Development-->
  <section class="cs-shape_wrap_4 cs-parallax">
    <div class="container">
      <div class="row">
        <div class="col-12">
          <div class="cs-section_heading cs-style1">
            <h2 class="cs-section_title">Integration and Development</h2>
          </div>
          <div class="cs-height_30 cs-height_lg_45"></div>
        </div>
      </div>
      ...
      <div class="row">
        <div class="col-md-4 mb-4">
          <div class="services_block">
            <!-- <em><img src="assets/img/icons/services/Web-Development.svg" alt="Web Development" width="40" /></em> -->
            <h4 class="h5 mb-2">API Integrations</h4>
            <p>Seamless integration is key to system efficiency. Our expertise in API integrations connects your software with almost any third-party application, expanding its functionality and versatility.</p>
          </div>
        </div>
        ...
        <div class="col-md-4 mb-4">
          <div class="services_block">
            <!-- <em><img src="assets/img/icons/services/Game-Development.svg" alt="" width="40" /></em> -->
            <h4 class="h5 mb-2">Web3 Development</h4>
            <p>Step into the future of the internet with our Web3 development services. From smart contracts to token-gating, our developers are at the forefront of blockchain technology, ready to bring your ideas to life.</p>
          </div>
        </div> 
      </div>
    </div>
  ...
  <section class="cs-shape_wrap_4 cs-parallax">
    <div class="container">
      <div class="row">
        <div class="col-12">
          <div class="cs-section_heading cs-style1">
            <h2 class="cs-section_title">Ongoing Support</h2>
          </div>
          <div class="cs-height_30 cs-height_lg_45"></div>
        </div>
      </div>
      ...
      <div class="row">
        <div class="col-md-4 mb-4">
          <div class="services_block">
            <!-- <em><img src="assets/img/icons/services/Web-Development.svg" alt="Web Development" width="40" /></em> -->
            <h4 class="h5 mb-2">Software Maintenance</h4>
            <p>Keep your software in prime condition with our comprehensive maintenance services. From routine updates to adding new features, we ensure your software evolves with your business.</p>
          </div>
        </div>
        ...
        <div class="col-md-4 mb-4">
          <div class="services_block">
            <!-- <em><img src="assets/img/icons/services/Game-Development.svg" alt="" width="40" /></em> -->
            <h4 class="h5 mb-2">Conclusion</h4>
            <p>At Caron Infotech, we're more than just a service provider; we're your digital transformation partner. With our human-centric approach, cutting-edge technology, and bespoke solutions, we're ready to take your project from vision to victory. Let's embark on this journey together.</p>
          </div>
        </div> 
      </div>
    </div>
      ...
      <div class="cs-tabs cs-style1">
        <div class="cs-tabs_heading">
          <div class="cs-section_heading cs-style1">
            ...
            <h2 class="cs-section_title">Pricing for client</h2>
          </div>
            ...
            <div class="row">
              <div class="col-lg-4">
                <div class="cs-pricing_table cs-style1">
                  ...
                  <div class="cs-pricing_info">
                    <div class="cs-price">
                      <h3 class="cs-white_color">$2000/</h3>
              ...
              <div class="col-lg-4">
                <div class="cs-pricing_table cs-style1">
                  ...
                  <div class="cs-pricing_info">
                    <div class="cs-price">
                      <h3 class="cs-white_color">$3500/</h3>
                      <span class="cs-accent_color">Yearly</span>
                    </div>
                    <div class="cs-price_text">Per subscriber per year</div>
                  </div>
              ...
              <div class="col-lg-4">
                <div class="cs-pricing_table cs-style1">
                  ...
                  <div class="cs-pricing_info">
                    <div class="cs-price">
                      <h3 class="cs-white_color">$4000/</h3>
                      <span class="cs-accent_color">Yearly</span>
                    </div>
                    <div class="cs-price_text">Per subscriber per year</div>
                  </div>
              ...
              <div class="col-lg-4">
                <div class="cs-pricing_table cs-style1">
                  ...
                  <div class="cs-pricing_info">
                    ...
                    <div class="cs-price_text">Per subscriber per month</div>
                  </div>
                  <ul class="cs-pricing_feature cs-mp0">
                    <li>
                      <span class="cs-feature_icon cs-accent_color">
                      ...
                      <span>1 Active Sprint Per Week</span>
                    </li>
                    <li>
                      <span class="cs-feature_icon cs-accent_color">
                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <li>
                      ...
                      <span>Unlimited Task Requests</span>
                    </li>
                    <li>
                      <span class="cs-feature_icon cs-accent_color">
                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                      ...
                      <span>Unlimited Revision Requests</span>
                    </li>
                    <li>
                      <span class="cs-feature_icon cs-accent_color">
                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                      ...
                      <span>Dedicated UI/UX Designer</span>
                    </li>
                    <li>
                      <span class="cs-feature_icon cs-accent_color">
                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <li>
                      ...
                      <span>Bi-Weekly Development Meeting</span>
                    </li>
                    <li>
                      <span class="cs-feature_icon cs-accent_color">
                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="cs-pricing_table cs-style1">
                  ...
                  <ul class="cs-pricing_feature cs-mp0">
                    <li>
                      ...
                      <strong>2 Active Sprint Per Week</strong>
                    </li>
                    <li>
                      <span class="cs-feature_icon cs-accent_color">
                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                      ...
                      <strong>2 Dedicated Developer</strong>
                    </li>
                    <li>
                      <span class="cs-feature_icon cs-accent_color">
                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="cs-pricing_table cs-style1">
                  ...
                  <ul class="cs-pricing_feature cs-mp0">
                    ...
                    <li>
                      ...
                      <strong>Unlimited Task Requests</strong>
                    </li>
                    <li>
                      <span class="cs-feature_icon cs-accent_color">
                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                      ...
                      <strong>Unlimited Revision Requests</strong>
                    </li>
                    <li>
                      <span class="cs-feature_icon cs-accent_color">
                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                      ...
                      <strong>1 Dedicated UI/UX Designer</strong>
                    </li>
                    <li>
                      <span class="cs-feature_icon cs-accent_color">
                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <li>
                      ...
                      <span>Mainatainanince and support </span>
                    </li>
                  </ul>
                  <div class="cs-pricing_btn_wrap">
                    <a href="#" class="cs-text_btn">
      ...
      <div class="cs-cta cs-style1 cs-bg text-center cs-shape_wrap_1 cs-position_1" data-src="assets/img/cta_bg.jpeg">
        ...
        <div class="cs-cta_in">
          ...
          <a href="contacts.php" class="cs-text_btn">
            <span>
              <a href="javascript:void(0)" data-open="quote">Get a Quote</a>
            </span>
            <svg width="26" height="12" viewBox="0 0 26 12" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path
